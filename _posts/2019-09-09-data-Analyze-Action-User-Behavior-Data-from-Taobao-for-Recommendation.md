...
- 与非付费用户相比，付费用户的点击贡献量更大，平均25.34次点击贡献一个商品。针对此现象，可以建立更加具有深度的用户画像，将商品更加精准地推送给用户。

- 针对非付费用户点击最多的商品，可以通过优惠券、红包、返利或是推送更具性价比的同类商品给用户等形式促进用户购买。

- 晚间从19点开始，用户各种行为开始上升，至21~22点左右达到一天的最高峰。心理学研究表面，到了晚上10点左右，大脑内部的感受网络计算能力不足，对情绪控制能力下降（**补充参考文献**）。消费，或者说冲动消费，很大程度上与控制能力下降有关。用户的行为，与前沿心理学研究一致。从运营角度看，可以在这个时间短开展更多的活动。如引导更多用户在该时间段进入客户端，并通过限时优惠等活动刺激用户购买。
